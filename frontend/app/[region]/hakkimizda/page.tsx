...
const T = {
  ...
  en: {
    metaTitle: 'About us — CyberTestify',
    metaDesc: 'CyberTestify provides an AI-powered, automated security pre-assessment for verified domains.',
    title: 'About us',
    introHtml: '<strong>CyberTestify</strong> is an AI-based <strong>security pre-assessment</strong> service designed to help businesses spot security risks in their web assets early. We work only against the domain whose ownership <strong>you have verified</strong>, using non-intrusive and largely passive methods, and turn the findings into a clear report with concrete remediation recommendations.',
    ...
    methodTitle: 'Our methodology — three-tier verification',
    methodHtml: 'CyberTestify combines an <strong>Autonomous AI Red-Team + deterministic security verification</strong> approach. Trust is placed not in a person but in <strong>the process and the evidence</strong>: every finding is tied not to the engine\'s word but to stored <strong>raw request/response evidence</strong>. Findings are transparently classified into three tiers:',
    tiers: [
      { t: 'Evidenced', d: 'A finding confirmed by a deterministic signature in the raw request/response. Overall risk is derived from these alone.' },
      { t: 'Inconclusive', d: 'Evidence exists but no definitive signature — it is not hidden; it is openly left for human verification.' },
      { t: 'Phantom', d: 'Claims with no trace in the raw material (or out of scope) are discarded — false positives and noise never enter the report.' },
    ],
    methodFootHtml: '<strong>Deterministic request/response evidence trail:</strong> only confirmed findings are reported; unconfirmed claims are honestly discarded. This keeps the report free of noise and reliable.',
    isoTitle: 'Isolation & security',
    iso: [
      '<strong>Isolated sandbox / ephemeral infrastructure:</strong> active tests run in a single-use, isolated environment with egress denied by default on every run.',
      '<strong>256-bit encrypted reports:</strong> every report is end-to-end encrypted and opened with an access code unique to you.',
      '<strong>UK GDPR-focused processing:</strong> structural PII masking and domain ownership verification are prerequisites.',
    ],
    limitsTitle: 'Our limits',
    limitsHtml: 'Our service is not a substitute for a formal audit or certification (e.g. ASV/QSA); it is intended for awareness and early detection. Reports are generated by AI and factual statements should not be used without independent verification.',
    weTitle: 'What we are / what we are not',
    weAre: 'What we are',
    weAreList: [
      'A fast, affordable security <strong>pre-assessment</strong>.',
      '<strong>Automated</strong> scanning and reporting with AI.',
      'A practical first layer for SMEs, agencies and software teams.',
    ],
    weNot: 'What we are not',
    weNotList: [
      'Not a formal / court-admissible <strong>pentest or audit</strong>.',
      'Not a replacement for a bank/enterprise <strong>red team</strong>.',
      'Not a product with an annual enterprise contract.',
    ],
    whyTitle: 'Why CyberTestify?',
    why: [
      '<strong>A one-off fixed price with no surprise costs.</strong>',
      '<strong>English report + UK GDPR-focused checks.</strong>',
      '<strong>No scan without verified domain ownership</strong> (security first).',
    ],
    contactTitle: 'Contact',
    moreHtml: 'For more information, see our',
    moreLink: 'Contact',
    moreTail: 'page.',
  },
} as const;
