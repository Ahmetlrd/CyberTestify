...
export interface Dict {
  nav: { how: string; why: string; packages: string; login: string; cta: string };
  hero: {
    badge: string;
    titleA: string;
    titleHi: string;
...
const tr: Dict = {
  nav: { how: 'Nasıl Çalışır', why: 'Neden Biz', packages: 'Paketler', login: 'Giriş', cta: 'Ücretsiz Doğrula' },
  hero: {
...
const en: Dict = {
  nav: { how: 'How It Works', why: 'Why Us', packages: 'Pricing', login: 'Log in', cta: 'Verify Free' },
  hero: {
