...
function buildCmsHardeningFix(detected: boolean, locale: string = 'tr'): string {
  ...
  return [
    ...
    '',
    '```php',
    t("define( 'WP_AUTO_UPDATE_CORE', 'minor' );  // güvenlik/minor sürümleri otomatik", "define( 'WP_AUTO_UPDATE_CORE', 'minor' );  // Sicherheits-/Minor-Versionen automatisch"),
    '```',
    '',
    ...
    'version: 2',
    'updates:',
    t('  - package-ecosystem: "composer"   # WordPress/PHP için; npm/pip/… da desteklenir', '  - package-ecosystem: "composer"   # für WordPress/PHP; npm/pip/… werden ebenfalls unterstützt'),
    '    directory: "/"',
